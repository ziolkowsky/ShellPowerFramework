...
New log files will be created each day with proper timestamp at beginning of filename. New entries will be append to existing files.
...
GitHub : github.com/ziolkowsky/ShellPowerFramework
